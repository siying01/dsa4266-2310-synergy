'''This script takes in the parsed csv training file with labels to train the random forest model'''
import pandas as pd
...
file_path_train = (base_path / 'data/dataset0.csv').resolve() #add file name
